...
const About = () => {
  ...
  return (
    <motion.section
      id="about"
      className="w-full h-full bg-blue-950 lg:bg-gray-50 lg:block py-10"
      ref={ref}
    ...
    >
      <div
        className="lg:w-full mx-auto lg:mx-0 rounded-2xl shadow-2xl lg:rounded-none py-9 lg:py-0 w-[80%] lg:bg-gray-50 bg-white  place-items-center px-6 grid grid-cols-1 items-center">
